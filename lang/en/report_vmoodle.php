...
$string['cnxed'] = 'Connected';
$string['cnxratio'] = '(Connected ratio)';
...
$string['events'] = 'Q';
$string['files'] = 'Files';
$string['fixvsdraftfiles'] = 'Permanent / Draft';
...
$string['neverconnected'] = 'Never connected';
$string['connected'] = 'Connected (once at least)';
$string['nodata'] = 'No data';
$string['allyears'] = 'All years';
$string['nologreader'] = 'No log reader enabled';
$string['nologstore'] = 'No logstore identified or usable. Actual reader has {$class} class';
...
$string['appfiles'] = 'Zips and applications';
$string['bigfiles'] = 'Big files (> 1M)';
$string['bigfilessize'] = 'Big files size';
$string['january'] = 'Jan';
$string['february'] = 'Feb';
$string['march'] = 'Mar';
$string['april'] = 'Apr';
